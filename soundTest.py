...
note_schedule = [
    ...
    VisualNote("Gb1", 102.97, 0.5),
    VisualNote("Eb2", 104.03, 0.37),
    VisualNote("Gb2", 102.97, 0.43),
    VisualNote("B3", 103.73, 0.1),
    VisualNote("B3", 104.03, 0.47),
    VisualNote("Db4", 102.97, 0.37),
    ...
    VisualNote("Bb3", 128.83, 1.83),

    VisualNote("E1", 130.93, 1.27),
    VisualNote("Ab1", 130.93, 1.4),
    VisualNote("B1", 130.93, 1.37),
    VisualNote("E2", 130.93, 1.4),
    VisualNote("Gb3", 130.93, 0.33),
    ...
    VisualNote("Ab1", 133.13, 1.47),
    VisualNote("B1", 133.13, 1.4),
    VisualNote("Eb2", 133.13, 1.43),
    VisualNote("Ab2", 133.13, 1.4),
    ...
    VisualNote("Db4", 133.13, 0.3),
    VisualNote("Eb4", 132.87, 0.43),

    VisualNote("B1", 135.3, 1.6),
    VisualNote("Eb2", 135.3, 1.6),
    VisualNote("Gb2", 135.3, 1.5),
    VisualNote("B2", 135.3, 1.33),
    VisualNote("Gb3", 135.3, 0.33),
    VisualNote("Gb3", 136.13, 0.33),
    VisualNote("Ab3", 135.63, 0.17),
    VisualNote("Ab3", 135.9, 0.3),
    VisualNote("Ab3", 136.47, 0.17),

    VisualNote("Gb1", 137.57, 1.53),
    VisualNote("Bb1", 137.57, 1.5),
    VisualNote("Db2", 137.57, 1.43),
    VisualNote("Gb2", 137.57, 1.33),
    ...
    VisualNote("E1", 139.77, 1.27),
    VisualNote("Ab1", 139.77, 1.4),
    VisualNote("B1", 139.77, 1.37),
    VisualNote("E2", 139.77, 1.4),
    ...
    VisualNote("Gb1", 146.4, 1.37),
    VisualNote("Bb1", 146.4, 1.37),
    VisualNote("Db2", 146.4, 1.37),
    VisualNote("Gb2", 146.4, 1.4),
    VisualNote("Bb3", 146.4, 0.73),
    ...
    VisualNote("Eb4", 155.53, 0.63),
    VisualNote("Eb4", 156.7, 0.47),

    VisualNote("Db2", 157.77, 1.13),
    ...
    VisualNote("Eb4 ", 183.87, 0.23),
    VisualNote("Eb4 ", 184.7, 0.13),
    VisualNote("E4", 184.2, 0.13),
    ...
    VisualNote("B1", 186.4, 1.53),
    VisualNote("Eb2", 186.4, 1.6),
    VisualNote("Ab2", 186.4, 1.6),
    VisualNote("Gb4", 187.27, 0.3),
    VisualNote("Gb4", 188.33, 0.1),
    VisualNote("Ab4", 186.4, 0.4),
    VisualNote("Ab4", 187.03, 0.27),
    VisualNote("Ab4", 187.57, 0.83),
    VisualNote("B4", 186.8, 0.3),
    VisualNote("Db5", 186.4, 0.47),
    VisualNote("Eb5", 185.93, 0.53),

    VisualNote("B1", 188.67, 1.6),
    VisualNote("Eb2", 188.67, 1.6),
    VisualNote("Gb2", 188.67, 1.5),
    VisualNote("B2", 188.67, 1.4),
    VisualNote("Eb4", 188.67, 0.3),
    VisualNote("Gb4", 188.67, 0.37),
    ...
    VisualNote("Gb1", 190.97, 1.73),
    VisualNote("Bb1", 190.97, 1.63),
    VisualNote("Db2", 190.97, 1.57),
    VisualNote("Gb2", 190.97, 1.43),
    VisualNote("Gb4", 191.9, 0.33),
    VisualNote("Gb4", 192.73, 0.17),
    VisualNote("Ab4", 191.67, 0.3),
    VisualNote("Ab4", 192.2, 0.6),
    VisualNote("Bb4", 190.97, 0.37),
    VisualNote("B4", 191.43, 0.3),
    VisualNote("Db5", 190.97, 0.5),

    VisualNote("E1", 193.23, 1.63),
    VisualNote("Ab1", 193.23, 1.73),
    VisualNote("B1", 193.23, 1.67),
    VisualNote("E2", 193.23, 1.67),
    VisualNote("E4", 193.23, 0.43),
    VisualNote("E4", 193.93, 0.3),
    VisualNote("E4", 194.37, 0.1),
    VisualNote("Gb4", 193.23, 0.43),
    VisualNote("Gb4", 194.13, 0.3),
    VisualNote("G4", 194.93, 0.4),
    VisualNote("Ab4", 193.67, 0.1),
    VisualNote("Ab4", 193.93, 0.33),
    VisualNote("Ab4", 194.37, 0.17),
    VisualNote("B4",194.93, 0.3),
    VisualNote("Eb5", 194.93, 0.43),

    VisualNote("Ab1", 195.5, 1.8),
    VisualNote("B1", 195.5, 1.73),
    VisualNote("Eb2", 195.5, 1.8),
    VisualNote("Ab2", 195.5, 1.9),
    VisualNote("Gb4", 196.33, 0.37),
    VisualNote("G4", 197.13, 0.17),
    VisualNote("Ab4", 195.5, 0.37),
    VisualNote("Ab4", 196.13, 0.3),
    VisualNote("Ab4", 196.67, 0.17),
    VisualNote("B4", 195.9, 0.3),
    VisualNote("B4", 197.23, 0.17),
    VisualNote("Db5", 195.5, 0.43),
    VisualNote("Eb5", 197.23, 0.17),

    VisualNote("B1", 197.73, 1.43),
    VisualNote("Eb2", 197.73, 1.47),
    VisualNote("Gb2", 197.73, 1.43),
    VisualNote("B2", 197.73, 1.37),
    VisualNote("Eb4", 197.73, 0.4),
    VisualNote("Eb4", 199.37, 0.17),
    VisualNote("Gb4", 197.73, 0.43),
    ...
    VisualNote("Gb1", 199.93, 1.47),
    VisualNote("Bb1", 199.93, 1.47),
    VisualNote("Db2", 199.93, 1.43),
    VisualNote("Gb2", 199.93, 1.43),
    VisualNote("Db4", 199.93, 1.5),
    VisualNote("Gb4", 199.93, 1.5),
    VisualNote("Bb4", 199.93, 1.43),
...
# Played: Eb1 at 34.10s
# Played: Eb2 at 34.10s
# Played: B3 at 34.10s
# Played: Db4 at 34.98s
# Played: D4 at 34.98s
# Played: Ab1 at 35.18s
# Played: Ab2 at 35.18s
# Played: Ab3 at 35.18s
# Played: Eb4 at 35.18s
